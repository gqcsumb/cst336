    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <div id="editingMessage" class="display-5">Please select a hero!</div>
            </div>
        </div>
        
        <!-- Create new button -->
        <form method="POST" action="adminAddNew.php">
          <button id='newBtn' type='submit' class='btn btn-info btn-block' name='new' value='hero'>Add A New Hero</button>
        </form>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
              <?php
                ...
                foreach ($heroes as $h) {
                        echo "<tr>";
                        echo "<th scope='row'>" . $h['id'] . "</th>";
                        echo "<td>" . $h['name'] ."</td>";
                        echo "<td><img id='heroImages' src='" . $h['imageLink'] ."'/></td>";
                        echo "<td>" . $h['description'] ."</td>";
                        echo "<td>$" . $h['price'] .".00</td>";
                        echo "<td>";
                        echo "<form method='POST' action='./adminEdit.php'>
                                <div class='form-group'>
                                <button class='btn btn-success' type='submit' name='editBtn' value='" . $h['name'] . "'>Edit</button>";
                        echo "</form>";
                        echo "<form method='POST' action='./adminDelete.php'>
                                <div class='form-group'>
                                <button id='deleteBtn' class='btn btn-danger' type='submit' name='deleteBtn' value='" . $h['name'] . "'>Delete</button>";
                        echo "</form>";
                        echo "</td>";
                        echo "</tr>";
                      }
